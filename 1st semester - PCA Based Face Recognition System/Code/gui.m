...
PCAtrain = load('train_output.mat');
trainData = data.trainData;
testData = data.testData;
train_output = PCAtrain.train_output;
...
[m1face,m2face,m3face] = FindMatchedFace(testImage,fileName,trainData,train_output);
axes(handles.axes2);
imshow(m1face.image,[])
title(['1st match: ' m1face.name ' % = ' num2str(m1face.percentage)])
axes(handles.axes3);
imshow(m2face.image,[])
title(['2nd match: ' m2face.name ' % = ' num2str(m2face.percentage)])
axes(handles.axes4);
imshow(m3face.image,[])
title(['3rd match: ' m3face.name ' % = ' num2str(m3face.percentage)])
